...
COMPLETION_WAITING_DOTS="false"  # Display red dots whilst waiting for completion.
DISABLE_UNTRACKED_FILES_DIRTY="true"  # Disable marking untracked files as dirty
setopt NULL_GLOB  # Don't error out on zero matches
setopt NO_BEEP
...
setopt HIST_VERIFY  # Don't execute history command immediately
